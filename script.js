...
$(document).ready(function () {
    ...
    map.on('idle', () => {
        ...
        for (const id of toggleableLayerIds) {
            const buttonId = id.replace(/ /g, '-').toLowerCase(); // Ensure buttonId matches the button IDs
    ...
    document.getElementById('written-works').addEventListener('click', function () {
        toggleLayerVisibility('Written Works');
    });
    document.getElementById('photography').addEventListener('click', function () {
        toggleLayerVisibility('Photography');
    });
    document.getElementById('social-media').addEventListener('click', function () {
        toggleLayerVisibility('Social Media');
    });
    document.getElementById('vendors').addEventListener('click', function () {
        toggleLayerVisibility('Vendors');
    });
